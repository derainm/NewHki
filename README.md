...
When we stoped to add new hotkeys, i try to contact crimsoncantab to update but he had an issue with python version:
...
- Use js and html to do a key board to allow user to edit VK key hex code.
